                    ...
                    <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
                      <thead>
                        <tr style={{ borderBottom: "2px solid var(--border)" }}>
                          <th style={{ textAlign: "left", padding: "8px 6px", fontWeight: 700, fontSize: 12 }}>Date</th>
                          <th style={{ textAlign: "left", padding: "8px 6px", fontWeight: 700, fontSize: 12 }}>Groupe</th>
                          <th style={{ textAlign: "left", padding: "8px 6px", fontWeight: 700, fontSize: 12 }}>Titre</th>
                          <th style={{ textAlign: "left", padding: "8px 6px", fontWeight: 700, fontSize: 12 }}>Lien</th>
